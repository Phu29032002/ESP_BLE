...
uint8_t service_data[] = { 'S', 'A', 'L', 'E', ' ', 'O', 'F', 'F'};
static esp_ble_adv_data_t adv_data = {
    ...
    .manufacturer_len = 0,  // Set manufacturer data length to 0
    .p_manufacturer_data = NULL,  // Set manufacturer data pointer to NULL
};
...
void app_main()
{
    ...
    ESP_ERROR_CHECK(esp_ble_gap_set_device_name("SALE OFF"));
